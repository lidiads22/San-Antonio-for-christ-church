...
<template>
  ...
  :class="[
    ...
    'absolute lg:static transition-all duration-300 w-full py-12 lg:py-0 ' +
    'left-1/2 -translate-x-1/2 lg:opacity-100 lg:translate-x-0 ' +
    'lg:pointer-events-auto lg:bg-transparent lg:w-auto ' +
    'top-20 sm:top-24 bg-[#475F45] z-50'
  ]"
>
...
<section id="gallery" class="py-12 bg-gray-50">
  ...
  <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
    ...
    <div class="group relative overflow-hidden rounded-lg shadow">
      <img
        src="/src/img/churchPictureWorship.webp"
